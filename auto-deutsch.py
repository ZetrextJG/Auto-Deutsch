...
from functions.translators import process_data
...
class Application():
    def __init__(self, master):
        ...
        root.geometry('240x60')  # set new geometry
...
def main():
    ...
    print("Starting app...")
    parser = argparse.ArgumentParser(description="Automatic deutch translator")
    parser.add_argument('--pln', help="Enables experimental translation to Polish language")
